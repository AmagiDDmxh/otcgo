<template>
                ...
                <div class="creatWallet-body" style="width:100%">
                    <div class="row" style="margin-top:35px">
                        ...
                        <div class="col-xs-3" style="padding-left:0px;">
                            <span class="error-text" style="display:inline-block;margin-top:5px;" v-if="username.length >=20">  用户名不能超过20位 </span>
                            <span v-else-if="username==''" class="error-text" style="display:inline-block;margin-top:5px;"> 用户名不能为空</span>
                    ...
                    <div class="row" style="margin-top:10px">
                        ...
                        <div class="col-xs-3" style="padding-left:0px;">
                            <span class="error-text" style="display:inline-block;margin-top:5px;" v-if="password1.length < 8 && password1.length >0">  密码不能小于8位 </span>
 ...
 密码不能为空
                    ...
                    <div class="row" style="margin-top:10px">
                        ...
                        <div class="col-xs-3" style="padding-left:0px;">
                            <span class="error-text" style="display:inline-block;margin-top:5px;" v-if="password2.length < 8 && password1.length > 0">  密码不能小于8位 </span>
 ...
 密码不能为空
                    ...
                    <div class="row" style="margin-top:10px">
                        ...
                        <div class="col-xs-6">
                            <button type="button" class="btn  btn-lj form-control" style="border-radius: 6px;" @click="creatWallet">
                                下一步
                            </button>
                        </div>
                    </div>
