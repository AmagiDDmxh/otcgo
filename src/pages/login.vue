    ...
    <div class="container-fluid">
        ...
        <div class="container" style="background: #fff;">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-10 col-sm-offset-2 col-md-7 col-md-offset-2 col-lg-7 col-lg-offset-2">
                    <div>
                        <form class="from-group login">
                            <div class="input-group">
                                ...
                                <label class="input-group-addon btn-bs-file btn  btn-select-file btn-primary btn-lj">
                                    浏览<input type="file" id="file" :value="filevalue" accept=".json,application/json"/>
                                </label>
                                <span v-show="filenameError" style="display:inline-block;padding-left:10px;"
                                      class="error-text">
                                        {{filenameError}}
                                    </span>
                            </div>
                            <div class="input-group">
                                ...
                                <span v-else style="display:inline-block;padding-left:10px;"> <img
                                        src="/src/assets/yes.png"/> </span>
                            </div>
                            <div class="input-group">
