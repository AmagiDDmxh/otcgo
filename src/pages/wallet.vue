            ...
            <div class="content col-xs-9 col-lg-9">
                ...
                <div>
                    <div class="row" style="margin-top:55px;">
                        ...
                        <div class="col-xs-6">
                            <p style="margin-bottom:15px"> <span class="link-span"> {{ $route.query.filename }}</span> 的钱包文件已生成在浏览器的下载路径， 请注意查收！
                            </p>
                            <p style="margin-bottom:15px;"> 若钱包文件没有自动下载,请 <span class="link-span" @click="downloadfile">点此下载！</span>的注意事项！</p>
                            <p style="margin-bottom:15px;"> 请认真阅读关于 <span class="link-span">钱包文件,
