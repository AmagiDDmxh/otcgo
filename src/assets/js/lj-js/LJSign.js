...
(function() {
	...
	LJCurveFp.prototype.p = function () {
		return this.__p;
	};
	LJCurveFp.prototype.a = function () {
		return this.__a;
	};
	LJCurveFp.prototype.b = function () {
		return this.__b;
	};
	...
	LJPoint.prototype.x = function () {
		return this.__x;
	};
	LJPoint.prototype.y = function () {
		return this.__y;
	};
	LJPoint.prototype.curve = function () {
		return this.__curve;
	};
	LJPoint.prototype.order = function () {
		return this.__order;
	};
	LJPoint.prototype.double = function () {
		if (null == this.x() && null == this.y() && null == this.curve()) {
			return INFINITY;
		}
	...
	LJPoint.prototype.mul = function (other) {
		...
		if (this.x() == null && this.y() == null && this.curve() == null) {
			return INFINITY;
		}
		if (e.compare(0) <= 0) {
			alert('e must be a positive LJBigInteger');
		}
		var e3 = e.multiply(3);
	...
	LJSigningKey = function (prvhex, curve = SECP256r1) {
		...
		if (-1 == this.secexp.compare(1) || 0 <= this.secexp.compare(n)) {
